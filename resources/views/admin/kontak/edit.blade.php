...
@section('content')
<h2 class='fw-bold mb-4'>Edit Kontak</h2>
...
<div class='mb-3'><label class='form-label'>Phone number</label><input type='text' class='form-control' name='phone_number' value="{{ old('phone_number', $item->phone_number) }}" required></div>
